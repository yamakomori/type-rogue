export const FISH_SPECIES = [
  ...
  { id: "grass-seahorse", name: "うみくさタツノオトシゴ", habitat: "潮だまり", regionId: "tidepool", stages: ["S07", "S08"], color: "#91ae70", accent: "#f3e6a1", shape: "tall", movement: "drift" },
  { id: "moon-squid", name: "つきイカ", habitat: "潮だまり", regionId: "tidepool", stages: ["S07", "S08"], color: "#b6a2ca", accent: "#e9e6f5", shape: "tall", movement: "drift" },
  ...
  { id: "deep-jelly", name: "よるクラゲ", habitat: "潮だまり", regionId: "tidepool", stages: ["S08"], color: "#a98cc2", accent: "#d8f3f0", shape: "tall", movement: "drift" },
  ...
  { id: "clownfish", name: "カクレクマノミ", habitat: "浅瀬", regionId: "shallows", stages: ["SH01", "SH02"], color: "#ee7f36", accent: "#f7efe0", shape: "round", rarity: "common", sprite: { src: "/sprites/clownfish-strip.png", frames: 4, frameMs: 280, sourceFacing: "right" } },
  { id: "sand-ray", name: "すなひかりエイ", habitat: "浅瀬", regionId: "shallows", stages: ["SH03", "SH04"], color: "#7db5a4", accent: "#d8f4df", shape: "long", rarity: "common", sprite: { src: "/sprites/sand-ray-strip.png", frames: 4, frameMs: 300, sourceFacing: "right" } },
  { id: "ribbon-eel", name: "ゆらりウツボ", habitat: "浅瀬", regionId: "shallows", stages: ["SH05", "SH06"], color: "#8f86ce", accent: "#e7defb", shape: "long" },
  { id: "bubble-jelly", name: "あわクラゲ", habitat: "浅瀬", regionId: "shallows", stages: ["SH07"], color: "#ef8fa5", accent: "#ffe4eb", shape: "tall", movement: "drift" },
  ...
  { id: "coral-butterfly", name: "さんごチョウチョウウオ", habitat: "珊瑚の森", regionId: "coral-forest", stages: ["CO01", "CO02"], color: "#f19a5b", accent: "#fff0b8", shape: "round", rarity: "common", sprite: { src: "/sprites/coral-butterfly-strip.png", frames: 4, frameMs: 280, sourceFacing: "right" } },
